...
public class JmDNS extends JFrame implements ServiceListener, ServiceTypeListener, ListSelectionListener {
    ...
    JmDNS(JmmDNS mmDNS) throws IOException {
        super("JmDNS Browser");
        this.jmmdns = mmDNS;
    ...
    public static void main(String argv[]) throws IOException {
        new JmDNS(JmmDNS.Factory.getInstance());
    }
}