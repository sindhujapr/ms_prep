...
/** Main class for the control test. */
...
class SynchronizedObject {
  public String name;
  public SynchronizedObject(String aName) { name = aName; }
  public synchronized void synchronizedMethod() {
      String message = name + " lock acquired by thread " + Thread.currentThread().getName(); 
...
abstract class GrabberBase extends Thread {
   ...
   public GrabberBase(SynchronizedObject left, SynchronizedObject right, String name) {
     super(name);
     leftObject  = left;
     rightObject = right; 
   } 
...
class RightToLeftGrabber extends GrabberBase {
      public RightToLeftGrabber( SynchronizedObject left, SynchronizedObject right) {
          super(left, right, "RightToLeft");
      }

      public void run() {
         while(true) { grabRightToLeft(); }
      }
...
class LeftToRightGrabber extends GrabberBase {
      public LeftToRightGrabber( SynchronizedObject left, SynchronizedObject right) {
